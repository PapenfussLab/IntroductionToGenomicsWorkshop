...
```{r, echo=FALSE}
knitr::include_graphics("../inst/extdata/Example-of-a-best-practices-SNV-calling-workflow-for-somatic-exome-and-genome-data.png")
# knitr::include_graphics(system.file("extdata", "Example-of-a-best-practices-SNV-calling-workflow-for-somatic-exome-and-genome-data.png", package = "IntroductionToGenomicsWorkshop"))
```
...
```{r, eval = TRUE}
file_dir <- "../inst/extdata/COLO829R_COLO829T_strelka_passed.somatic.merged.vcf"
vcf <- readVcf(file_dir)
# vcf <- readVcf(system.file("extdata", "COLO829R_COLO829T_strelka_passed.somatic.merged.vcf", package = "IntroductionToGenomicsWorkshop"))
```
