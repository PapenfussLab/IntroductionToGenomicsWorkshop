...
knitr::include_graphics(system.file("images", "Example-of-a-best-practices-SNV-calling-workflow-for-somatic-exome-and-genome-data.png", package = "IntroductionToGenomicsWorkshop"))
```
